...
thumbnailImage: recyclerView/recyclerview1_thumb.jpg
coverImage: recyclerView/recyclerview1_cover.jpg
...
showSocial: false
---
RecyclerView，一个强大的控件，既支持纵向滚动，又支持横向滚动。
应用场景非常广泛，简单说ListView可以做的它可以做，ListView不支持的横向它也可以做。
...
{{< image classes="fancybox center fig-100" src="/recyclerView/recyclerview1.jpg" thumbnail="/recyclerView/recyclerview1.jpg" title="settings效果图">}}
...
{{< image classes="fancybox center fig-100" src="/recyclerView/recyclerview2.jpg" thumbnail="/recyclerView/recyclerview2.jpg" title="wifiSettings效果图">}}
...
[本文所有实例代码下载](https://github.com/YangYang48/project/tree/master/MyRecyclerView)
...
# 参考
[[1] Frank-Zhu, RecyclerView使用详解(二), 2015.](http://frank-zhu.github.io/android/2015/01/16/android-recyclerview-part-1/)

[[2] Mr.杨__一个刚入行的码农, RecyclerView的基本使用, 2020.](https://blog.csdn.net/nishuoniaiwoma/article/details/108350761)

[[3]sean_depp, Android RecyclerView从入门到玩坏, 2018.](https://www.imooc.com/article/68704)
